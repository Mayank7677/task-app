      ...
      <div class="flex h-[700px] w-full">
        <div class="w-full flex flex-col items-center justify-center">
          <form onSubmit={handleSubmit} class="md:w-96 w-80 flex flex-col items-center justify-center">
            <h2 class="text-4xl  font-medium">Log in</h2>
            ...
            <div class="flex items-center w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
              ...
              <input
                ...
                class="bg-transparent  placeholder-gray-500/80 outline-none text-sm w-full h-full"
                required
              />
            </div>
            ...
            {/* <div class="w-full flex justify-end mt-8 text-purple-500">
            ...
            <div className="w-full">
              <button className="mt-5 w-full   bg-gradient-to-r from-purple-400 to-violet-600 text-white border-none text-sm font-light py-2 px-20 rounded-full cursor-pointer">
                Login
              </button>
            </div>
            <p class="text-gray-500/90 text-sm mt-4">
              Don’t have an account?{" "}
              <Link to={"/signup"} class="text-purple-500 hover:underline">
                Sign up
              </Link>
            </p>
          </form>
